...
<div class="form-horizontal">
    <div class="form-group">
        <label class="col-lg-2 control-label"><?php echo Yii::t('wojia', 'Administrator ID'); ?></label>
    ...
    <div class="form-group">
        <label class="col-lg-2 control-label"><?php echo Yii::t('wojia', 'Administrator name'); ?></label>
