<?php
/** @var $form CustomerIndexForm */
/** @var $widget CActiveForm */

/** @var $this CustomerController */
$this->pageTitle = Yii::t('wojia', 'Customers');
...
$actionWidth = 16;
if ($user->checkAccess('customer:view'))
    $actionWidth += 40;
if ($user->checkAccess('customer:update'))
    $actionWidth += 40;
if ($user->checkAccess('customer:active'))
    $actionWidth += 40;

/** @var $clientScript CClientScript */
$clientScript = Yii::app()->clientScript;
$clientScript->registerCss('customer-index', '
.table-column-actions {width: ' . $actionWidth . 'px}
');
$clientScript->registerScript('customer-index', '
...
?>
    ...
    <div class="page-header">
        <h1><?php echo Yii::t('wojia', 'Customers'); ?></h1>
    </div>
...
<?php if ($dataProvider->itemCount): ?>
    <table class="table table-striped">
        <thead>
        <tr>
            <th class="table-column-id"><?php echo Yii::t('wojia', 'Customer ID'); ?></th>
                    ...
                    <div class="btn-group">
                        <?php if ($user->checkAccess('customer:view')): ?>
                            <a class="btn btn-default"
                               href="<?php echo $this->createUrl('customer/view', array('id' => $data->id)); ?>"
                               title="<?php echo Yii::t('wojia', 'View'); ?>">
                                <span class="glyphicon glyphicon-eye-open"></span>
                            </a>
                        <?php endif; ?>
                        <?php if ($user->checkAccess('customer:update')): ?>
                            <a class="btn btn-default"
                               href="<?php echo $this->createUrl('customer/update', array('id' => $data->id)); ?>"
                               title="<?php echo Yii::t('wojia', 'Edit'); ?>">
                                <span class="glyphicon glyphicon-edit"></span>
                            </a>
                        <?php endif; ?>
                        <?php if ($user->checkAccess('customer:active')): ?>
                            <a class="btn btn-danger"
                               href="<?php echo $this->createUrl('customer/active', array('id' => $data->id)); ?>"
...
<?php else: ?>
    <p><?php echo Yii::t('wojia', 'No customers.'); ?></p>
<?php endif; ?>